  ...
  return (
    <Modal visible transparent animationType="fade" onRequestClose={handleClose}>
      <TouchableWithoutFeedback onPress={handleClose}>
        <View style={[styles.detailOverlay, isMobile && { padding: 0, justifyContent: 'flex-end' }]}>
          <TouchableWithoutFeedback>
            <View style={[styles.detailModal, isMobile && { width: '100%', maxWidth: '100%', maxHeight: '90%', borderWidth: 0, padding: 10, borderTopLeftRadius: 20, borderTopRightRadius: 20, borderBottomLeftRadius: 0, borderBottomRightRadius: 0 }, HARD_SHADOW_LG]}>
